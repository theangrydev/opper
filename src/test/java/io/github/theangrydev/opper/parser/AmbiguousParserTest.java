...
public class AmbiguousParserTest {

    @Test
    public void shouldRecogniseAnAmbiguousGrammar() throws IOException {
        Grammar grammar = new GrammarBuilder()
                .withAcceptanceSymbol("ACCEPT")
                .withStartSymbol("START")
                .withRule("START", "A")
                .withRule("START", "START", "PLUS", "START")
                .build();
        Scanner scanner = FixedScanner.scanner(grammar, "A", "PLUS", "A", "PLUS", "A");
